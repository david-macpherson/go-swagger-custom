...
func NewRestapiAPI(spec *loads.Document) *RestapiAPI {
	return &RestapiAPI{
		...
		UploadBigFileHandler: UploadBigFileHandlerFunc(func(params UploadBigFileParams) middleware.Responder {
			return middleware.NotImplemented("operation UploadBigFile has not yet been implemented")
		}),
	}
}

/*RestapiAPI go-swagger custom extension scratch pad */
type RestapiAPI struct {
	...
	// UploadBigFileHandler sets the operation handler for the upload big file operation
	UploadBigFileHandler UploadBigFileHandler
...
func (o *RestapiAPI) Validate() error {
	...
	if o.UploadBigFileHandler == nil {
		unregistered = append(unregistered, "UploadBigFileHandler")
	}
...
func (o *RestapiAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/{firstName}_{lastName}"] = NewUploadBigFile(o.context, o.UploadBigFileHandler)
}
